...
{/* Web section */}
            ...
            <div className=' md:bg-[#404040] h-full bg-black max-md:bg-opacity-70 p-3 md:p-4 rounded-sm'>
                <h2 className='text-base md:text-lg font-semibold text-gray-200'>{t('web-title')}</h2>
                <div className='flex h-full items-center'>
                    <div className='text-gray-300 md:mt-4 ml-4 w-full md:w-1/3'>
                        <div className='my-2 md:my-3'>
                            <h3 className='text-sm md:text-base font-semibold'>{t('frontend')}</h3>
                        ...
                        <div className='my-2 md:my-3'>
                            <h3 className='text-sm md:text-base font-semibold'>{t('backend')}</h3>
                            <ul className='mt-1 md:mt-0 ml-1 md:ml-2 text-xs md:text-sm'>
                        ...
                        <div className='my-2 md:my-3'>
                            <h3 className='text-sm md:text-base font-semibold'>{t('database')}</h3>
                            <ul className='mt-1 md:mt-0 ml-1 md:ml-2 text-xs md:text-sm'>
                                <li>PostgreSQL</li>
                            </ul>
                        </div>
...
{/* Android section */}
            ...
            <div className=' p-3 h-full md:p-4 md:bg-[#404040] bg-black max-md:bg-opacity-70 rounded-sm'>
                <h2 className='text-base md:text-lg font-semibold text-gray-200'>{t('android-title')}</h2>
                <div className='flex h-full items-center'>
                    <div className='text-gray-300 md:mt-4 ml-4 w-full md:w-1/3'>
                        <div className='my-2 md:my-3'>
                            <h3 className='text-sm md:text-base font-semibold'>{t('frontend')}</h3>
